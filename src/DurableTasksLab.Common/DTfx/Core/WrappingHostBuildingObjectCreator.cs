...
public class WrappingHostBuildingObjectCreator<T> : ObjectCreator<T> where T : class
{
    private readonly IServiceProvider serviceProvider;
    private readonly ObjectCreator<T> targetObjectCreator;

    public WrappingHostBuildingObjectCreator(IServiceProvider serviceProvider, ObjectCreator<T> targetObjectCreator)
    {
